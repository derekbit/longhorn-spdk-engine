...
func exposeSnapshotLvolBdev(spdkClient *spdkclient.Client, lvsName, lvolName, ip string, port int32, executor helperutil.Executor) (subsystemNQN, controllerName string, err error) {
