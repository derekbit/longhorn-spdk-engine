...
func (e *Engine) BackupRestore(spdkClient *SPDKClient, backupUrl, engineName, snapshotName string, credential map[string]string, concurrentLimit int32) (*spdkrpc.EngineBackupRestoreResponse, error) {
	e.Lock()
	defer e.Unlock()
