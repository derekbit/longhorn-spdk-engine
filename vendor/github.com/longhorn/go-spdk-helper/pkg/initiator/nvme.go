...
// DisconnectControllerByAddress disconnects a single NVMe controller that
...
func DisconnectControllerByAddress(nqn, ip, port string, executor *commonns.Executor) error {
