...
type DiskLvolListRequest struct {
	DiskName             string   `protobuf:"bytes,1,opt,name=disk_name,json=diskName,proto3" json:"disk_name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *DiskLvolListRequest) Reset()         { *m = DiskLvolListRequest{} }
func (m *DiskLvolListRequest) String() string { return proto.CompactTextString(m) }
func (*DiskLvolListRequest) ProtoMessage()    {}
func (*DiskLvolListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f86dfec2b2acc42c, []int{17}
}

func (m *DiskLvolListRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DiskLvolListRequest.Unmarshal(m, b)
}
func (m *DiskLvolListRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DiskLvolListRequest.Marshal(b, m, deterministic)
}
func (m *DiskLvolListRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DiskLvolListRequest.Merge(m, src)
}
func (m *DiskLvolListRequest) XXX_Size() int {
	return xxx_messageInfo_DiskLvolListRequest.Size(m)
}
func (m *DiskLvolListRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_DiskLvolListRequest.DiscardUnknown(m)
}

var xxx_messageInfo_DiskLvolListRequest proto.InternalMessageInfo

func (m *DiskLvolListRequest) GetDiskName() string {
	if m != nil {
		return m.DiskName
	}
	return ""
...
type DiskLvolListResponse struct {
	Lvols                map[string]*Lvol `protobuf:"bytes,1,rep,name=lvols,proto3" json:"lvols,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}         `json:"-"`
	XXX_unrecognized     []byte           `json:"-"`
	XXX_sizecache        int32            `json:"-"`
}

func (m *DiskLvolListResponse) Reset()         { *m = DiskLvolListResponse{} }
func (m *DiskLvolListResponse) String() string { return proto.CompactTextString(m) }
func (*DiskLvolListResponse) ProtoMessage()    {}
func (*DiskLvolListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f86dfec2b2acc42c, []int{18}
}

func (m *DiskLvolListResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DiskLvolListResponse.Unmarshal(m, b)
}
func (m *DiskLvolListResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DiskLvolListResponse.Marshal(b, m, deterministic)
}
func (m *DiskLvolListResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DiskLvolListResponse.Merge(m, src)
}
func (m *DiskLvolListResponse) XXX_Size() int {
	return xxx_messageInfo_DiskLvolListResponse.Size(m)
}
func (m *DiskLvolListResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_DiskLvolListResponse.DiscardUnknown(m)
}

var xxx_messageInfo_DiskLvolListResponse proto.InternalMessageInfo

func (m *DiskLvolListResponse) GetLvols() map[string]*Lvol {
	if m != nil {
		return m.Lvols
	}
	return nil
...
type DiskLvolDeleteRequest struct {
	DiskName             string   `protobuf:"bytes,1,opt,name=disk_name,json=diskName,proto3" json:"disk_name,omitempty"`
	DiskUuid             string   `protobuf:"bytes,2,opt,name=disk_uuid,json=diskUuid,proto3" json:"disk_uuid,omitempty"`
	LvolName             string   `protobuf:"bytes,3,opt,name=lvol_name,json=lvolName,proto3" json:"lvol_name,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *DiskLvolDeleteRequest) Reset()         { *m = DiskLvolDeleteRequest{} }
func (m *DiskLvolDeleteRequest) String() string { return proto.CompactTextString(m) }
func (*DiskLvolDeleteRequest) ProtoMessage()    {}
func (*DiskLvolDeleteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f86dfec2b2acc42c, []int{20}
}

func (m *DiskLvolDeleteRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DiskLvolDeleteRequest.Unmarshal(m, b)
}
func (m *DiskLvolDeleteRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DiskLvolDeleteRequest.Marshal(b, m, deterministic)
}
func (m *DiskLvolDeleteRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DiskLvolDeleteRequest.Merge(m, src)
}
func (m *DiskLvolDeleteRequest) XXX_Size() int {
	return xxx_messageInfo_DiskLvolDeleteRequest.Size(m)
}
func (m *DiskLvolDeleteRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_DiskLvolDeleteRequest.DiscardUnknown(m)
}

var xxx_messageInfo_DiskLvolDeleteRequest proto.InternalMessageInfo

func (m *DiskLvolDeleteRequest) GetDiskName() string {
	if m != nil {
		return m.DiskName
	}
	return ""
...
func (m *DiskLvolDeleteRequest) GetDiskUuid() string {
	if m != nil {
		return m.DiskUuid
	}
	return ""
...
func (m *DiskLvolDeleteRequest) GetLvolName() string {
	if m != nil {
		return m.LvolName
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*DiskLvolListRequest)(nil), "spdkrpc.DiskLvolListRequest")
	proto.RegisterType((*DiskLvolListResponse)(nil), "spdkrpc.DiskLvolListResponse")
	proto.RegisterMapType((map[string]*Lvol)(nil), "spdkrpc.DiskLvolListResponse.LvolsEntry")
	proto.RegisterType((*DiskDeleteRequest)(nil), "spdkrpc.DiskDeleteRequest")
	proto.RegisterType((*DiskLvolDeleteRequest)(nil), "spdkrpc.DiskLvolDeleteRequest")
}
...
var fileDescriptor_f86dfec2b2acc42c = []byte{
	...
	,
}
...
type SPDKServiceClient interface {
	...
	DiskLvolList(ctx context.Context, in *DiskLvolListRequest, opts ...grpc.CallOption) (*DiskLvolListResponse, error)
	DiskLvolDelete(ctx context.Context, in *DiskLvolDeleteRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *sPDKServiceClient) DiskLvolList(ctx context.Context, in *DiskLvolListRequest, opts ...grpc.CallOption) (*DiskLvolListResponse, error) {
	out := new(DiskLvolListResponse)
	err := c.cc.Invoke(ctx, "/spdkrpc.SPDKService/DiskLvolList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sPDKServiceClient) DiskLvolDelete(ctx context.Context, in *DiskLvolDeleteRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/spdkrpc.SPDKService/DiskLvolDelete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SPDKServiceServer interface {
	...
	DiskLvolList(context.Context, *DiskLvolListRequest) (*DiskLvolListResponse, error)
	DiskLvolDelete(context.Context, *DiskLvolDeleteRequest) (*empty.Empty, error)
...
func (*UnimplementedSPDKServiceServer) DiskLvolList(ctx context.Context, req *DiskLvolListRequest) (*DiskLvolListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DiskLvolList not implemented")
}
func (*UnimplementedSPDKServiceServer) DiskLvolDelete(ctx context.Context, req *DiskLvolDeleteRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DiskLvolDelete not implemented")
}
...
func _SPDKService_DiskLvolList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DiskLvolListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SPDKServiceServer).DiskLvolList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spdkrpc.SPDKService/DiskLvolList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SPDKServiceServer).DiskLvolList(ctx, req.(*DiskLvolListRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SPDKService_DiskLvolDelete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DiskLvolDeleteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SPDKServiceServer).DiskLvolDelete(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/spdkrpc.SPDKService/DiskLvolDelete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SPDKServiceServer).DiskLvolDelete(ctx, req.(*DiskLvolDeleteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _SPDKService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DiskLvolList",
			Handler:    _SPDKService_DiskLvolList_Handler,
		},
		{
			MethodName: "DiskLvolDelete",
			Handler:    _SPDKService_DiskLvolDelete_Handler,
		},
		{
